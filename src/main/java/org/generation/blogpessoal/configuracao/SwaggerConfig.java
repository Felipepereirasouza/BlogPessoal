...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("API - Blog Pessoal Felipe").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/felipepereirasouza")
				.contact(contact()).build();
	}

	private static Contact contact() {

		return new Contact("Felipe Pereira ", "https://github.com/felipepereirasouza", "felipepereirasouza@outlook.com");
